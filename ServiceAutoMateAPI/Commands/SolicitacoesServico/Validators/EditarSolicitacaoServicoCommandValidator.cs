...
{
    public class EditarSolicitacaoServicoCommandValidator : AbstractValidator<EditarSolicitacaoServicoCommand>
    {
        public EditarSolicitacaoServicoCommandValidator()
        {
            ClassLevelCascadeMode = CascadeMode.Continue;

            RuleFor(command => command.Id)
                .NotEmpty().WithMessage("O ID da solicitação de serviço não pode ser vazio.");
